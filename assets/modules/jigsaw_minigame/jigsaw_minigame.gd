...
@export var piece_positions = {
	"piece #1": Vector2(20, 20),
	"piece #2": Vector2(20, 108),
	"piece #3": Vector2(20, 216),
	"piece #4": Vector2(20, 288)
}
...
var note_manager: JigsawNotesManager = JigsawNotesManager.new()
var current_piece 

func _ready() -> void:
	jigsaw_manager.initialize(self)
	note_manager.initialize(self)
