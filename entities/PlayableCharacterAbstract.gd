class_name PlayableCharacter extends CharacterBody3D
...
var movement_manager: CharacterMovementManager = CharacterMovementManager.new(self)
...
func _physics_process(delta: float) -> void:
	movement_manager._physics_process(delta)
